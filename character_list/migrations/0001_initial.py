# Generated by Django 4.0.4 on 2022-07-03 10:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worldview', models.CharField(default='neutral', max_length=200)),
                ('age', models.CharField(blank=True, default=20, max_length=20, null=True)),
                ('weight', models.CharField(blank=True, default='100 см', max_length=20, null=True)),
                ('height', models.CharField(blank=True, default='100 см', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('ideal', models.TextField(blank=True, max_length=200, null=True)),
                ('bond', models.TextField(blank=True, max_length=200, null=True)),
                ('flaw', models.TextField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dmg_bonus', models.IntegerField(blank=True, default=0, null=True)),
                ('dmg_type', models.CharField(blank=True, max_length=150, null=True)),
                ('base_stat', models.CharField(blank=True, max_length=100, null=True)),
                ('difficult', models.CharField(blank=True, default=1, max_length=200, null=True)),
                ('lvl_spell', models.IntegerField(blank=True, default=1, null=True)),
                ('limit_per_day', models.IntegerField(blank=True, default=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis', models.IntegerField(blank=True, default=0, null=True)),
                ('history', models.IntegerField(blank=True, default=0, null=True)),
                ('magic', models.IntegerField(blank=True, default=0, null=True)),
                ('nature', models.IntegerField(blank=True, default=0, null=True)),
                ('religion', models.IntegerField(blank=True, default=0, null=True)),
                ('attentiveness', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('animal_care', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('conviction', models.IntegerField(blank=True, default=0, null=True)),
